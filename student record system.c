//Student Records Management System made using C by Sambit Mohanty, Gourab Das Mohapatra and Mohammed Anas.
#include <stdio.h>
#include <string.h>
#include <conio.h>
#include <stdlib.h>
...
int main(){
    ...
    SetConsoleTitle("Student Record System by Sambit Mohanty, Gourab Das Mohapatra and Mohammed Anas");
    window();
    //use_pass_field();
    main_window();
    return 0;
